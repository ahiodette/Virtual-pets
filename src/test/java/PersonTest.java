...
public class PersonTest {
    @Test
    public void person_instatiateCorrectly_true(){
        Person testPerson = new Person("Henry", "[email protected] (http://moringacore-java.herokuapp.com/cdn-cgi/l/email-protection)");
